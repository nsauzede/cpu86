...
xst -ifn xst.scr
move clk32to40_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk32to40_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk32to40_exdes.ucf clk32to40_exdes

echo 'Running map'
map -timing -pr b clk32to40_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk32to40_exdes -w routed.ncd routed.vhd
cd ..
